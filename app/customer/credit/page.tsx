...
import { useCreditStore, CreditTransaction } from '@/store/creditStore';
  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-5 duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-outline-variant/30 pb-6">
        <div>
          <h2 className="font-headline-lg text-headline-lg text-primary font-black tracking-tight">Enterprise Credit Ledger</h2>
          <p className="font-body-lg text-body-lg text-on-surface-variant mt-1">Record and manage organizational income credits, salary paychecks, and funding entries.</p>
        </div>
      ...
      <Card className="bg-surface-container-lowest flex flex-col md:flex-row gap-4 items-center px-lg py-md" glass={false}>
        ...
        <div className="relative flex-1 w-full focus-within:ring-2 ring-primary/10 rounded-lg">
          ...
          <input
            type="text"
            placeholder="Search income title or descriptions..."
            value={search}
              ...
              <TableRow>
                <TableCell colSpan={6} className="text-center py-12 text-on-surface-variant">
                  <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <p className="font-title-md text-title-md font-bold text-on-surface">No income entries found</p>
      ...
      {/* Record Income Modal (Add) */}
      <Modal isOpen={isAddOpen} onClose={() => setIsAddOpen(false)} title="Record New Income" customHeader={true} cardPadding="p-0" maxWidth="max-w-2xl">
        <div className="px-xl py-lg border-b border-outline-variant flex justify-between items-center bg-surface-container-low/50">
          <div>
            <h2 className="font-headline-sm text-headline-sm text-on-surface">Record New Income</h2>
            <p className="font-label-md text-label-md text-on-surface-variant mt-1">Record a new credit transaction for your enterprise ledger.</p>
          </div>
        ...
        <form onSubmit={handleSubmitAdd(onSaveAdd)}>
          <div className="px-xl py-xl space-y-lg max-h-[70vh] overflow-y-auto overflow-x-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-lg">
              <div className="flex flex-col gap-sm">
                <div className="flex items-center gap-xs">
                  ...
                  <div className="relative group">
                    <span className="material-symbols-outlined text-[16px] text-outline cursor-help select-none">help</span>
                    <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 hidden group-hover:block w-48 p-2 bg-inverse-surface text-inverse-on-surface text-[10px] rounded shadow-md z-30 leading-normal">
                      Select Salary for paychecks, Savings for interests, or Gift/Returns.
                    </div>
                  </div>
                </div>
                <div className="relative">
              ...
              <div className="flex flex-col gap-sm">
                <label className="font-label-md text-label-md text-on-surface-variant uppercase font-bold">Date Received *</label>
                <input
                  type="date"
            ...
            {/* Type (Full Row) */}
            <div className="flex flex-col gap-sm">
              <label className="font-label-md text-label-md text-on-surface-variant uppercase font-bold">Deposit Type *</label>
              <div className="relative">
                <select
                  {...registerAdd('type')}
                  className="w-full h-12 bg-surface-container-lowest border border-outline-variant rounded-lg px-md font-body-md text-body-md appearance-none focus:border-secondary focus:ring-2 focus:ring-secondary/20 focus:outline-none font-bold text-on-surface"
            ...
            <div className="flex flex-col gap-sm">
              <div className="flex items-center gap-xs">
                ...
                <div className="relative group">
                  <span className="material-symbols-outlined text-[16px] text-outline cursor-help select-none">help</span>
                  <div className="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 hidden group-hover:block w-48 p-2 bg-inverse-surface text-inverse-on-surface text-[10px] rounded shadow-md z-30 leading-normal">
                    Enter any internal memos, reference codes, or source details.
                  </div>
                </div>
              </div>
              <textarea
                ...
                placeholder="Add details about the source or purpose of this income..."
                rows={3}
              />
            </div>
          </div>
      ...
      {/* Edit Income Modal */}
      <Modal isOpen={isEditOpen} onClose={() => setIsEditOpen(false)} title="Edit Income Entry" customHeader={true} cardPadding="p-0" maxWidth="max-w-2xl">
        <div className="px-xl py-lg border-b border-outline-variant flex justify-between items-center bg-surface-container-low/50">
          <div className="flex items-center gap-sm">
            <span className="material-symbols-outlined text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>edit_note</span>
            <h2 className="font-headline-sm text-headline-sm text-on-surface">Edit Income Entry</h2>
          </div>
        ...
        {selectedCredit && (
          <>
                ...
                {selectedCredit.documentName ? (
                  <>
                    <div 
                      ...
                      className="group relative aspect-[3/4] w-full bg-surface-container rounded-lg border border-outline-variant overflow-hidden cursor-pointer hover:shadow-md transition-shadow flex items-center justify-center animate-in fade-in"
                    >
                      {isPreviewLoading && (
            ...
            <div className="px-xl py-lg bg-surface-bright border-t border-outline-variant flex justify-end items-center gap-md">
              ...
              <button className="px-xl py-2 font-title-md text-title-md bg-secondary text-on-secondary rounded-lg hover:bg-secondary/90 active:scale-95 transition-all flex items-center gap-sm font-semibold cursor-pointer" onClick={() => handleOpenEdit(selectedCredit)}>
